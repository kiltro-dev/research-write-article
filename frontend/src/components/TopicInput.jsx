...
export default function TopicInput({ onGenerate, isGenerating }) {
  ...
  return (
    ...
    >
      <label className="block text-sm font-medium text-gray-400 mb-3">
        What topic should the agents write about?
      </label>
      ...
      <p className="mt-3 text-xs text-gray-600">
        Powered by multiple LLM providers with automatic fallback
      </p>
    </motion.form>
  )
}
