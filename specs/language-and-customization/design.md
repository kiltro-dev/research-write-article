...
- el usuario puede elegir el idioma de la interfaz,
- además puede elegir el idioma de escritura de los agentes,
- y también ajustar tono y longitud,
- con un comportamiento por defecto basado en el idioma del navegador.
...
1. Extender el modelo de solicitud de generación para aceptar:
   ...
   - length
   - perspective
2. Crear una función que construya los prompts base de los agentes usando el idioma del contenido y las opciones elegidas.
...
1. Añadir controles simples al formulario actual:
   ...
   - selector de idioma del contenido generado,
   - selector de tono,
   - selector de longitud,
   - selector de enfoque.
2. Mantener la interfaz limpia y visualmente atractiva.
3. Mostrar una pequeña etiqueta como:
   - “Interface: Español • Writing in English • Formal • Medium length”

## Diseño del prompt dinámico
El prompt de cada agente debe tener una base común y una capa de personalización:

- Planner: define la estructura del artículo según el idioma del contenido y el tono solicitado.
- Writer: genera el contenido en el idioma seleccionado para el artículo y con el tono solicitado.
- Editor: corrige estilo, claridad y coherencia en el mismo idioma del contenido.
...
- Usar el idioma del navegador como valor inicial para la interfaz y, si aplica, también para el contenido.
- Permitir que el usuario sobrescriba esos valores manualmente.
