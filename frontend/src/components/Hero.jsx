    ...
    <header className="relative pt-24 pb-16 px-4 text-center overflow-hidden">
      ...
      >
        ...
        <p className="max-w-2xl mx-auto text-lg text-gray-400 mb-10 leading-relaxed">
          Three specialized agents — <strong className="text-gray-200">Planner</strong>,{' '}
          <strong className="text-gray-200">Writer</strong>, and{' '}
          <strong className="text-gray-200">Editor</strong> — collaborate to research,
          write, and polish a full article on any topic you choose.
        </p>
